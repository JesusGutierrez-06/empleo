          ...
          <div class="container">
            <div class="row">
              ...
              <div class="main-button-red">
                  <div class="scroll-to-section"><a href="#contact">Contactanos</a></div>
              </div>
          </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  <div class="date">
                    <h6>Dic <span>10</span></h6>
                  </div>
                  <a href="meeting-details.html"><h4>Caja Nacional de Salud</h4></a>
                  <p>Santa Cruz - Bolivia<br> Ver más...</p>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
